...
const ProfilePage = () => {
  ...
  return (
    <div className="min-h-screen bg-gray-50">
      {/* Navbar */}
      <header className="px-4 lg:px-6 h-14 flex items-center border-b border-gray-200 bg-white relative">
        {/* Logo - Left aligned */}
        ...
        {/* Mobile Menu */}
        {isMenuOpen && (
          <div className="absolute top-14 left-0 right-0 bg-white border-b border-gray-200 lg:hidden z-50">
